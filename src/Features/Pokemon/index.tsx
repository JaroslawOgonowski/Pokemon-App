...
export const Pokemon = () => {
  ...
  return (
    ...
    <Main
      ...
      readMoreButton={true}
      articleContentFull={"The main concept of Pokémon revolves around a trainer who travels the world, captures diverse creatures called Pokémon, and trains them to battle other trainers. There are numerous generations of Pokémon games, each introducing new regions to explore, new Pokémon, and new adventures for players.\
